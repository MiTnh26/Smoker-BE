...
class ReviveAdserverCachedContainer extends Container
{
    ...
    {
        return $container->services['cache.psr16'] = new \Symfony\Component\Cache\Psr16Cache(new \Symfony\Component\Cache\Adapter\FilesystemAdapter('', '1200', 'C:\\xampp\\htdocs\\revive/var/cache'));
    }
    ...
    {
        return $container->services['filesystem'] = new \League\Flysystem\Filesystem(new \League\Flysystem\Adapter\Local('C:\\xampp\\htdocs\\revive\\www\\images', 0));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'webpath.admin' => 'localhost/revive/www/admin',
            'webpath.delivery' => 'localhost/revive/www/delivery',
            'webpath.deliverySSL' => 'localhost/revive/www/delivery',
            'webpath.images' => 'localhost/revive/www/images',
            'webpath.imagesSSL' => 'localhost/revive/www/images',
            ...
            'file.xmlrest' => 'ax.php',
            'store.mode' => '0',
            'store.webDir' => 'C:\\xampp\\htdocs\\revive\\www\\images',
            'store.ftpHost' => '',
            'store.ftpPath' => '',
            'store.ftpUsername' => '',
            'store.ftpPassword' => '',
            ...
            'delivery.secret' => 'S7LCVueooQRrzI0vWsRl6OulR2wFQKizvYv1ErsLhOg=',
            ...
            'email.qmailPatch' => '',
            'email.fromName' => '',
            'email.fromAddress' => 'minhtn2004@gmail.com',
            'email.fromCompany' => '',
