<?php /* Smarty version 2.6.18, created on 2025-11-24 18:19:06
...
<fieldset id="auditFilter">
    <legend><?php echo $this->_plugins['function']['t'][0](['str' => 'Filters'], $this);?>
</legend>

    <?php if ($this->_tpl_vars['showAdvertisers']): ?>
	<div class="filterWrapper">
	    <label class="filterLabel" for="advertiserId"><?php echo $this->_plugins['function']['t'][0](['str' => 'Advertiser'], $this);?>
</label>
	    <span>
	        <select style="width:25%" id="advertiserId" name="advertiserId" onchange="submitForm();">
	            <?php echo smarty_function_html_options(['options' => $this->_tpl_vars['aAdvertiser'],'selected' => $this->_tpl_vars['advertiserId']], $this);?>

	        </select>
	        <?php if ($this->_tpl_vars['aCampaign']): ?>
	        <select style="width:25%" id="campaignId" name="campaignId" onchange="submitForm();">
	            <?php echo smarty_function_html_options(['options' => $this->_tpl_vars['aCampaign'],'selected' => $this->_tpl_vars['campaignId']], $this);?>
   ...
   <?php endif; ?>
	...
	<div class="filterWrapper">
	    <label class="filterLabel" for="publisherId"><?php echo $this->_plugins['function']['t'][0](['str' => 'Publisher'], $this);?>
</label>
	    <span>
	        <select style="width:25%" id="publisherId" name="publisherId" onchange="submitForm();">
	            <?php echo smarty_function_html_options(['options' => $this->_tpl_vars['aPublisher'],'selected' => $this->_tpl_vars['publisherId']], $this);?>

	        </select>
	        <?php if ($this->_tpl_vars['aZone']): ?>
	        <select style="width:25%" id="zoneId" name="zoneId" onchange="submitForm();">
	            <?php echo smarty_function_html_options(['options' => $this->_tpl_vars['aZone'],'selected' => $this->_tpl_vars['zoneId']], $this);?>
	...
	<div class="filterWrapper">
	    <span class="filterLabel"><?php echo $this->_plugins['function']['t'][0](['str' => 'Date'], $this);?>
</span>
...
/images/ltr/go_blue.gif' border='0' tabindex='6' />
    ...
    <div>
        <input type="button" value="<?php echo $this->_plugins['function']['t'][0](['str' => 'Clear'], $this);?>
" onclick="resetFilter();" />
    </div>
</fieldset>
...
/images/info.gif' width='16' height='16' border='0' align='absmiddle'>
	    <?php echo $this->_plugins['function']['t'][0](['str' => 'AuditTrailDisabled'], $this);?>
...
"><?php echo $this->_plugins['function']['t'][0](['str' => 'Timestamp'], $this);?>
</a>
...
/images/caret-ds.gif" />
                ...
                <th><?php echo $this->_plugins['function']['t'][0](['str' => 'Event'], $this);?>
</th>
                <th width="10%">&nbsp;</th>
            </tr>
...
">
 ...
 <?php echo $this->_plugins['function']['t'][0](['str' => $this->_tpl_vars['aValue']['action']], $this);?>
...
" <?php if (! empty ( $this->_tpl_vars['aValue']['contextid'] )): ?>(#<?php echo $this->_tpl_vars['aValue']['contextid']; ?>
 ...
 (#<?php echo $this->_tpl_vars['aValue']['parentcontextid']; ?>
                    ...
                    <?php if (! empty ( $this->_tpl_vars['aValue']['hasChildren'] )): ?>
                        <?php echo $this->_plugins['function']['t'][0](['str' => 'AdditionalItems'], $this);?>
...
"><?php echo $this->_plugins['function']['t'][0](['str' => 'View'], $this);?>
</a></td>
            </tr>
...
">
                <td colspan="3">
                    <?php echo $this->_plugins['function']['t'][0](['str' => 'AuditResultsNotFound'], $this);?>
...
<div class="filters">
    <?php echo $this->_plugins['function']['t'][0](['str' => 'ItemsPerPage'], $this);?>
