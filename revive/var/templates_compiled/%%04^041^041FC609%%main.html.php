...
' wrap='off' dir='ltr' style='width:350px;'<?php echo $this->_plugins['function']['tabindex'][0]([], $this);?>
...
"<?php endif; ?><?php if ($this->_tpl_vars['_e']['disabled']): ?> disabled="disabled"<?php endif; ?>>
            <?php echo smarty_function_html_options(['options' => $this->_tpl_vars['_e']['options'],'selected' => $this->_tpl_vars['_e']['value']], $this);?>
