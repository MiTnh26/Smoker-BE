...
-select-all" class="checkbox select-all" /> <?php echo $this->_plugins['function']['t'][0](['str' => 'SelectUnselectAll'], $this);?>
</label></th>
      <th class="link"></th>
      <?php if (! empty ( $this->_tpl_vars['showStats'] )): ?>
          <th class="ctr"><?php echo $this->_plugins['function']['t'][0](['str' => 'FinanceCTR'], $this);?>
</th>
          <th class="cr"><?php echo $this->_plugins['function']['t'][0](['str' => 'FinanceCR'], $this);?>
</th>
          <th class="ecpm last"><?php echo $this->_plugins['function']['t'][0](['str' => 'FinanceCPM'], $this);?>
</th>
      <?php endif; ?>
    </tr>
  </tbody>
...
" type="checkbox" class="checkbox parent" /><?php echo $this->_plugins['function']['boldSearchPhrase'][0](['text' => $this->_tpl_vars['website']['name'],'search' => $this->_tpl_vars['text']], $this);?>

        </label>
      </td>
      <td class="link">
          <a title="<?php echo $this->_plugins['function']['t'][0](['str' => 'EditWebsite'], $this);?>
...
" type="checkbox" class="checkbox" />
            <?php echo $this->_plugins['function']['boldSearchPhrase'][0](['text' => $this->_tpl_vars['zone']['name'],'search' => $this->_tpl_vars['text']], $this);?>

        </label>
        </td>
        <td class="link">
            <a title="<?php echo $this->_plugins['function']['t'][0](['str' => 'EditZone'], $this);?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['website']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
">
        <?php echo $this->_plugins['function']['t'][0](['str' => 'NoWebsitesAndZones'], $this);?>

        <?php if ($this->_tpl_vars['text']): ?>
          <?php echo $this->_plugins['function']['t'][0](['str' => 'NoWebsitesAndZonesText','values' => ((is_array($_tmp=$this->_tpl_vars['text'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp))], $this);?>

        <?php endif; ?>

        <?php if ($this->_tpl_vars['checkboxPrefix'] == 'a'): ?>
        <?php echo $this->_plugins['function']['t'][0](['str' => 'ToLink'], $this);?>

        <?php else: ?>
        <?php echo $this->_plugins['function']['t'][0](['str' => 'ToUnlink'], $this);?>
...
-start-->
  <?php if ($this->_tpl_vars['status'] == 'linked'): ?>
  <?php echo $this->_plugins['function']['t'][0](['str' => 'Linked'], $this);?>
:
  <?php else: ?>
  <?php echo $this->_plugins['function']['t'][0](['str' => 'Available'], $this);?>
:
  <?php endif; ?>
  <span class="status-value"><?php echo $this->_tpl_vars['zonescounts']['all']; ?>
</span><br />

  <?php echo $this->_plugins['function']['t'][0](['str' => 'Showing'], $this);?>
