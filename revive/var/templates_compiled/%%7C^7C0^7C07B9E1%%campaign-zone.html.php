...
" />
  ...
  <div id="filters">
    <div id="filters-available">
      <h3 class="filter-panel-title"><?php echo $this->_plugins['function']['t'][0](['str' => 'AvailableZones'], $this);?>
</h3>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <div id="filters-linked">
      <h3 class="filter-panel-title"><?php echo $this->_plugins['function']['t'][0](['str' => 'LinkedZones'], $this);?>
</h3>
      <div class="filter-panel">
        <div class="bg-left"></div>
        <div class="bg-right"></div>
  ...
  <div id="select-zones">
          ...
          <table id="zones-available" class="zones new-table">
            <tbody>
              <tr class="header hide">
                <th class="name"><label><input type="checkbox" id="available-select-all" class="checkbox select-all" /> <?php echo $this->_plugins['function']['t'][0](['str' => 'SelectUnselectAll'], $this);?>
</label></th>
                <th class="link"></th>
      ...
      <div class="zones-container new-table-container">
        ...
        <div id="zones-linked-container">
          <table id="zones-linked" class="zones new-table">
            <tbody>
              <tr class="header hide">
                <th class="name"><label><input type="checkbox" id="linked-select-all" class="checkbox select-all" /> <?php echo $this->_plugins['function']['t'][0](['str' => 'SelectUnselectAll'], $this);?>
</label></th>
                <th class="link"></th>
                <th class="ctr"><?php echo $this->_plugins['function']['t'][0](['str' => 'FinanceCTR'], $this);?>
</th>
    ...
    <div id="linking-buttons">
      ...
      <div style="margin-top: 2ex; text-align: center">
        ...
        <span id="error-indicator" class="ajax-error hide"><?php echo $this->_plugins['function']['t'][0](['str' => 'LinkingNotSuccess'], $this);?>
</span>
      </div>
    </div>
  </div>

  <div class="accurate-info"><div class="accurate-box"></div><?php echo $this->_plugins['function']['t'][0](['str' => 'CalculatedForThisCampaign'], $this);?>
</div>
  <div class="estim-info"><div class="estim-box"></div><?php echo $this->_plugins['function']['t'][0](['str' => 'CalculatedForAllCampaigns'], $this);?>
</div>
