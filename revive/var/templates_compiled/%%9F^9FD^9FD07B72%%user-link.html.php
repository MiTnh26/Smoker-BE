 ...
 ?>
  ...
  <div class="controls">
    <?php if ($this->_tpl_vars['showLinkButton']): ?>
      <input value="<< <?php echo $this->_plugins['function']['t'][0](['str' => 'Back'], $this);?>
" type="button" <?php echo $this->_plugins['function']['tabindex'][0]([], $this);?>
 onclick="javascript:location.href='<?php echo $this->_tpl_vars['backUrl']; ?>
'">
      <input value="<?php echo $this->_plugins['function']['t'][0](['str' => 'LinkUser'], $this);?>
" class="main-submit" type="submit" <?php echo $this->_plugins['function']['tabindex'][0]([], $this);?>
>
      <?php if (! $this->_tpl_vars['existingUser']): ?><span class="hint"><?php echo $this->_plugins['function']['t'][0](['str' => 'NewUserWillBeCreated'], $this);?>
</span><?php endif; ?>
    <?php else: ?>
      <input value="<?php echo $this->_plugins['function']['t'][0](['str' => 'SaveChanges'], $this);?>
" class="main-submit" type="submit" <?php echo $this->_plugins['function']['tabindex'][0]([], $this);?>
>
    <?php endif; ?>
  </div>
