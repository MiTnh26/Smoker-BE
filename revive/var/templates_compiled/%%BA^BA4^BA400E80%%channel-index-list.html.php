<?php /* Smarty version 2.6.18, created on 2025-11-24 17:31:00
...
' class='inlineIcon iconTargetingChannelAdd'><?php echo $this->_plugins['function']['t'][0](['str' => 'AddNewChannel'], $this);?>
</a>
                <?php else: ?>
	            <span class='inlineIcon iconTargetingChannelAddDisabled'><?php echo $this->_plugins['function']['t'][0](['str' => 'AddNewChannel'], $this);?>
</span>
                <?php endif; ?>
            </li>
...
<?php echo $this->_plugins['function']['t'][0](['str' => 'ConfirmDeleteChannels'], $this);?>
<?php echo '")) {
    ...
    <table cellspacing='0' summary=''>
        <thead>
            <tr>
                ...
                <th>
                    <?php echo $this->_plugins['function']['t'][0](['str' => 'Name'], $this);?>

                </th>
                <?php if ($this->_tpl_vars['entityUrl'] != 'affiliate-channels.php'): ?>
                <th>
                    <?php echo $this->_plugins['function']['t'][0](['str' => 'Owner'], $this);?>
            ...
            <tr class='even'>
                <td colspan='<?php if ($this->_tpl_vars['entityUrl'] != 'affiliate-channels.php'): ?>5<?php else: ?>4<?php endif; ?>' class="hasPanel">
                    <div class='tableMessage'>
                        <div class='panel'>
                            <?php if ($this->_tpl_vars['entityUrl'] != 'affiliate-channels.php' || $this->_tpl_vars['affiliateId'] != -1): ?>
                                <?php echo $this->_plugins['function']['t'][0](['str' => 'NoChannels'], $this);?>

                            <?php else: ?>
                                <?php echo $this->_plugins['function']['t'][0](['str' => 'NoChannelsAddWebsite'], $this);?>
...
' class='inlineIcon iconTargetingChannel'><?php echo ((is_array($_tmp=$this->_tpl_vars['channel']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
                    ...
                    <?php echo $this->_plugins['function']['ox_entity_id'][0](['type' => 'Channel','id' => $this->_tpl_vars['channelId']], $this);?>
...
&channelid=<?php echo $this->_tpl_vars['channelId']; ?>
' class='inlineIcon iconTargetingChannelAcl'><?php echo $this->_plugins['function']['t'][0](['str' => 'EditChannelLimitations'], $this);?>
</a>
                        </li>
                    </ul>
                </td>
